...
public:
    ...
    TEST_METHOD(TestParserBasicQuery) {
        ...
        expectedResult.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Statement, "sss") }));
    ...
    TEST_METHOD(TestParser) {
        ...
        expectedResult.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "a") }));
    ...
    TEST_METHOD(TestParserCorrectMultipleDeclarations) {
        ...
        expectedResult.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Constant, "Select") }));
        expectedResult.relations = std::vector<Relation>({ Relation(Relation::Types::ModifiesS, Reference(Declaration(Declaration::DesignEntity::Assignment, "a")), Reference("\"x\"")) });
        expectedResult.patterns = std::vector<Pattern>();
        expectedResult.results = std::vector<std::string>();
    ...
    TEST_METHOD(TestParserValidAssignPattern) {
        ...
        expectedResult1.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "a") }));
        ...
        expectedResult2.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "a") }));
        ...
        expectedResult3.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "a") }));
        expectedResult2.relations = std::vector<Relation>();
        ...
        expectedResult4.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "a") }));
        ...
        expectedResult5.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "a") }));
        ...
        expectedResult6.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "a") }));
        ...
        expectedResult7.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "a") }));
        ...
        expectedResult8.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "a") }));
        ...
        expectedResult9.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "a") }));
    ...
    TEST_METHOD(TestParserValidIfPattern) {
        ...
        expectedResult1.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::If, "i") }));
        expectedResult1.relations = std::vector<Relation>();
        ...
        expectedResult2.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::If, "i") }));
        expectedResult2.relations = std::vector<Relation>();
        ...
        expectedResult3.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::If, "i") }));
    ...
    TEST_METHOD(TestParserValidWhilePattern) {
        ...
        expectedResult1.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::While, "w") }));
        expectedResult1.relations = std::vector<Relation>();
        ...
        expectedResult2.declarations.push_back(Declaration(Declaration::DesignEntity::Variable, "v"));
        expectedResult2.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::While, "w") }));
        expectedResult2.relations = std::vector<Relation>();
        ...
        expectedResult3.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::While, "w") }));
        expectedResult3.relations = std::vector<Relation>();
    ...
    TEST_METHOD(TestParserValidFollowsQueries) {
        ...
        expectedResult1.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "a1") }));
    ...
    TEST_METHOD(TestParserValidUsesSQueries) {
        ...
        expectedResult.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Print, "a") }));
        ...
        expectedResult1.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Statement, "s") }));
        ...
        expectedResult7.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Variable, "v") }));
    ...
    TEST_METHOD(TestParserValidUsesPQueries) {
        ...
        expectedResult1.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Procedure, "p") }));
        ...
        expectedResult2.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Procedure, "p") }));
        ...
        expectedResult3.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Procedure, "p") }));
    ...
    TEST_METHOD(TestParserValidModifiesSQueries) {
        ...
        expectedResult.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Read, "a") }));
    ...
    TEST_METHOD(TestParserValidCallsQueries) {
        ...
        expectedResult1.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Procedure, "p1") }));
        ...
        expectedResult4.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Procedure, "p") }));
        ...
        expectedResult5.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Procedure, "p") }));
        ...
        expectedResult6.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Procedure, "p") }));
        ...
        expectedResult7.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Procedure, "p") }));
        ...
        expectedResult8.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Procedure, "p") }));
        ...
        expectedResult9.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Procedure, "p") }));
    ...
    TEST_METHOD(TestParserValidNextQueries) {
        ...
        expectedResult1.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Statement, "p1") }));
        ...
        expectedResult2.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Statement, "p") }));
        ...
        expectedResult3.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Statement, "p") }));
        ...
        expectedResult4.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Statement, "p") }));
        ...
        expectedResult5.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Statement, "p") }));
        ...
        expectedResult6.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Statement, "p") }));
        ...
        expectedResult7.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Statement, "p") }));
        ...
        expectedResult8.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Statement, "p") }));
        ...
        expectedResult9.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Statement, "p") }));
    ...
    TEST_METHOD(TestParserValidAffects) {
        // Affects(synonym, synonym)
        std::string query1 = "assign p1, p2; Select p1 such that Affects(p1, p2)";
        QueryLexer lexer1 = QueryLexer(query1);
        std::vector<std::string> tokens1 = lexer1.lex();
        QueryParser parser1 = QueryParser(tokens1);
        ...
        expectedResult1.declarations = std::vector<Declaration>({ Declaration(Declaration::DesignEntity::Assignment, "p1"),  Declaration(Declaration::DesignEntity::Assignment, "p2") });
        expectedResult1.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "p1") }));
        expectedResult1.relations = std::vector<Relation>({ Relation(Relation::Types::Affects, Reference(Declaration(Declaration::DesignEntity::Assignment, "p1")), Reference(Declaration(Declaration::DesignEntity::Assignment, "p2"))) });
        expectedResult1.patterns = std::vector<Pattern>();
        expectedResult1.results = std::vector<std::string>();
        ...
        // Affects(synonym, _)
        std::string query2 = "assign p; Select p such that Affects(p, _)";
        QueryLexer lexer2 = QueryLexer(query2);
        std::vector<std::string> tokens2 = lexer2.lex();
        QueryParser parser2 = QueryParser(tokens2);
        ...
        expectedResult2.declarations = std::vector<Declaration>({ Declaration(Declaration::DesignEntity::Assignment, "p") });
        expectedResult2.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "p") }));
        expectedResult2.relations = std::vector<Relation>({ Relation(Relation::Types::Affects, Reference(Declaration(Declaration::DesignEntity::Assignment, "p")), Reference("_")) });
        expectedResult2.patterns = std::vector<Pattern>();
        expectedResult2.results = std::vector<std::string>();
        ...
        // Affects(synonym, INTEGER)
        std::string query3 = "assign p; Select p such that Affects(p, 12)";
        QueryLexer lexer3 = QueryLexer(query3);
        std::vector<std::string> tokens3 = lexer3.lex();
        QueryParser parser3 = QueryParser(tokens3);
        ...
        expectedResult3.declarations = std::vector<Declaration>({ Declaration(Declaration::DesignEntity::Assignment, "p") });
        expectedResult3.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "p") }));
        expectedResult3.relations = std::vector<Relation>({ Relation(Relation::Types::Affects, Reference(Declaration(Declaration::DesignEntity::Assignment, "p")), Reference("12")) });
        expectedResult3.patterns = std::vector<Pattern>();
        expectedResult3.results = std::vector<std::string>();
        ...
        // Affects(_, synonym)
        std::string query4 = "assign p; Select p such that Affects(_, p)";
        QueryLexer lexer4 = QueryLexer(query4);
        std::vector<std::string> tokens4 = lexer4.lex();
        QueryParser parser4 = QueryParser(tokens4);
        ...
        expectedResult4.declarations = std::vector<Declaration>({ Declaration(Declaration::DesignEntity::Assignment, "p") });
        expectedResult4.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "p") }));
        expectedResult4.relations = std::vector<Relation>({ Relation(Relation::Types::Affects, Reference("_"), Reference(Declaration(Declaration::DesignEntity::Assignment, "p"))) });
        expectedResult4.patterns = std::vector<Pattern>();
        expectedResult4.results = std::vector<std::string>();
        ...
        // Affects(_, _)
        std::string query5 = "assign p; Select p such that Affects(_, _)";
        QueryLexer lexer5 = QueryLexer(query5);
        std::vector<std::string> tokens5 = lexer5.lex();
        QueryParser parser5 = QueryParser(tokens5);
        ...
        expectedResult5.declarations = std::vector<Declaration>({ Declaration(Declaration::DesignEntity::Assignment, "p") });
        expectedResult5.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "p") }));
        expectedResult5.relations = std::vector<Relation>({ Relation(Relation::Types::Affects, Reference("_"), Reference("_")) });
        expectedResult5.patterns = std::vector<Pattern>();
        expectedResult5.results = std::vector<std::string>();
        ...
        // Affects(_, INTEGER)
        std::string query6 = "assign p; Select p such that Affects(_, 12)";
        QueryLexer lexer6 = QueryLexer(query6);
        std::vector<std::string> tokens6 = lexer6.lex();
        QueryParser parser6 = QueryParser(tokens6);
        ...
        expectedResult6.declarations = std::vector<Declaration>({ Declaration(Declaration::DesignEntity::Assignment, "p") });
        expectedResult6.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "p") }));
        expectedResult6.relations = std::vector<Relation>({ Relation(Relation::Types::Affects, Reference("_"), Reference("12")) });
        expectedResult6.patterns = std::vector<Pattern>();
        expectedResult6.results = std::vector<std::string>();
        ...
        // Affects(INTEGER, synonym)
        std::string query7 = "assign p; Select p such that Affects(12, p)";
        QueryLexer lexer7 = QueryLexer(query7);
        std::vector<std::string> tokens7 = lexer7.lex();
        QueryParser parser7 = QueryParser(tokens7);
        ...
        expectedResult7.declarations = std::vector<Declaration>({ Declaration(Declaration::DesignEntity::Assignment, "p") });
        expectedResult7.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "p") }));
        expectedResult7.relations = std::vector<Relation>({ Relation(Relation::Types::Affects, Reference("12"), Reference(Declaration(Declaration::DesignEntity::Assignment, "p"))) });
        expectedResult7.patterns = std::vector<Pattern>();
        expectedResult7.results = std::vector<std::string>();
        ...
        // Affects(INTEGER, _)
        std::string query8 = "assign p; Select p such that Affects(12, _)";
        QueryLexer lexer8 = QueryLexer(query8);
        std::vector<std::string> tokens8 = lexer8.lex();
        QueryParser parser8 = QueryParser(tokens8);
        ...
        expectedResult8.declarations = std::vector<Declaration>({ Declaration(Declaration::DesignEntity::Assignment, "p") });
        expectedResult8.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "p") }));
        expectedResult8.relations = std::vector<Relation>({ Relation(Relation::Types::Affects, Reference("12"), Reference("_")) });
        expectedResult8.patterns = std::vector<Pattern>();
        expectedResult8.results = std::vector<std::string>();
        ...
        // Affects(INTEGER, INTEGER)
        std::string query9 = "assign p; Select p such that Affects(12, 13)";
        QueryLexer lexer9 = QueryLexer(query9);
        std::vector<std::string> tokens9 = lexer9.lex();
        QueryParser parser9 = QueryParser(tokens9);
        ...
        expectedResult9.declarations = std::vector<Declaration>({ Declaration(Declaration::DesignEntity::Assignment, "p") });
        expectedResult9.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "p") }));
        expectedResult9.relations = std::vector<Relation>({ Relation(Relation::Types::Affects, Reference("12"), Reference("13")) });
        expectedResult9.patterns = std::vector<Pattern>();
        expectedResult9.results = std::vector<std::string>();
    ...
    TEST_METHOD(TestParserValidAffectsT) {
        // AffectsT(synonym, synonym)
        std::string query1 = "assign p1, p2; Select p1 such that Affects*(p1, p2)";
        QueryLexer lexer1 = QueryLexer(query1);
        std::vector<std::string> tokens1 = lexer1.lex();
        QueryParser parser1 = QueryParser(tokens1);
        ...
        expectedResult1.declarations = std::vector<Declaration>({ Declaration(Declaration::DesignEntity::Assignment, "p1"),  Declaration(Declaration::DesignEntity::Assignment, "p2") });
        expectedResult1.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "p1") }));
        expectedResult1.relations = std::vector<Relation>({ Relation(Relation::Types::AffectsT, Reference(Declaration(Declaration::DesignEntity::Assignment, "p1")), Reference(Declaration(Declaration::DesignEntity::Assignment, "p2"))) });
        expectedResult1.patterns = std::vector<Pattern>();
        expectedResult1.results = std::vector<std::string>();
        ...
        expectedResult2.declarations = std::vector<Declaration>({ Declaration(Declaration::DesignEntity::Assignment, "p") });
        expectedResult2.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "p") }));
        expectedResult2.relations = std::vector<Relation>({ Relation(Relation::Types::AffectsT, Reference(Declaration(Declaration::DesignEntity::Assignment, "p")), Reference("_")) });
        expectedResult2.patterns = std::vector<Pattern>();
        expectedResult2.results = std::vector<std::string>();
        ...
        // AffectsT(synonym, INTEGER)
        std::string query3 = "assign p; Select p such that Affects*(p, 3)";
        QueryLexer lexer3 = QueryLexer(query3);
        std::vector<std::string> tokens3 = lexer3.lex();
        QueryParser parser3 = QueryParser(tokens3);
        ...
        expectedResult3.declarations = std::vector<Declaration>({ Declaration(Declaration::DesignEntity::Assignment, "p") });
        expectedResult3.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "p") }));
        expectedResult3.relations = std::vector<Relation>({ Relation(Relation::Types::AffectsT, Reference(Declaration(Declaration::DesignEntity::Assignment, "p")), Reference("3")) });
        expectedResult3.patterns = std::vector<Pattern>();
        expectedResult3.results = std::vector<std::string>();
        ...
        expectedResult4.declarations = std::vector<Declaration>({ Declaration(Declaration::DesignEntity::Assignment, "p") });
        expectedResult4.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "p") }));
        expectedResult4.relations = std::vector<Relation>({ Relation(Relation::Types::AffectsT, Reference("_"), Reference(Declaration(Declaration::DesignEntity::Assignment, "p"))) });
        expectedResult4.patterns = std::vector<Pattern>();
        expectedResult4.results = std::vector<std::string>();
        ...
        expectedResult5.declarations = std::vector<Declaration>({ Declaration(Declaration::DesignEntity::Assignment, "p") });
        expectedResult5.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "p") }));
        expectedResult5.relations = std::vector<Relation>({ Relation(Relation::Types::AffectsT, Reference("_"), Reference("_")) });
        expectedResult5.patterns = std::vector<Pattern>();
        expectedResult5.results = std::vector<std::string>();
        ...
        // AffectsT(_, INTEGER)
        std::string query6 = "assign p; Select p such that Affects*(_, 4)";
        QueryLexer lexer6 = QueryLexer(query6);
        std::vector<std::string> tokens6 = lexer6.lex();
        QueryParser parser6 = QueryParser(tokens6);
        ...
        expectedResult6.declarations = std::vector<Declaration>({ Declaration(Declaration::DesignEntity::Assignment, "p") });
        expectedResult6.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "p") }));
        expectedResult6.relations = std::vector<Relation>({ Relation(Relation::Types::AffectsT, Reference("_"), Reference("4")) });
        expectedResult6.patterns = std::vector<Pattern>();
        expectedResult6.results = std::vector<std::string>();
        ...
        // AffectsT(INTEGER, synonym)
        std::string query7 = "assign p; Select p such that Affects*(4, p)";
        QueryLexer lexer7 = QueryLexer(query7);
        std::vector<std::string> tokens7 = lexer7.lex();
        QueryParser parser7 = QueryParser(tokens7);
        ...
        expectedResult7.declarations = std::vector<Declaration>({ Declaration(Declaration::DesignEntity::Assignment, "p") });
        expectedResult7.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "p") }));
        expectedResult7.relations = std::vector<Relation>({ Relation(Relation::Types::AffectsT, Reference("4"), Reference(Declaration(Declaration::DesignEntity::Assignment, "p"))) });
        expectedResult7.patterns = std::vector<Pattern>();
        expectedResult7.results = std::vector<std::string>();
        ...
        // AffectsT(INTEGER, _)
        std::string query8 = "assign p; Select p such that Affects*(2, _)";
        QueryLexer lexer8 = QueryLexer(query8);
        std::vector<std::string> tokens8 = lexer8.lex();
        QueryParser parser8 = QueryParser(tokens8);
        ...
        expectedResult8.declarations = std::vector<Declaration>({ Declaration(Declaration::DesignEntity::Assignment, "p") });
        expectedResult8.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "p") }));
        expectedResult8.relations = std::vector<Relation>({ Relation(Relation::Types::AffectsT, Reference("2"), Reference("_")) });
        expectedResult8.patterns = std::vector<Pattern>();
        expectedResult8.results = std::vector<std::string>();
        ...
        // AffectsT(INTEGER, INTEGER)
        std::string query9 = "assign p; Select p such that Affects*(2, 5)";
        QueryLexer lexer9 = QueryLexer(query9);
        std::vector<std::string> tokens9 = lexer9.lex();
        QueryParser parser9 = QueryParser(tokens9);
        ...
        expectedResult9.declarations = std::vector<Declaration>({ Declaration(Declaration::DesignEntity::Assignment, "p") });
        expectedResult9.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "p") }));
        expectedResult9.relations = std::vector<Relation>({ Relation(Relation::Types::AffectsT, Reference("2"), Reference("5")) });
        expectedResult9.patterns = std::vector<Pattern>();
        expectedResult9.results = std::vector<std::string>();
    ...
    TEST_METHOD(TestParserValidWith) {
        ...
        expectedResult9.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ Declaration(Declaration::DesignEntity::Assignment, "a9") }));
        expectedResult9.relations = std::vector<Relation>();
        expectedResult9.patterns = std::vector<Pattern>();
    ...
    TEST_METHOD(TestParserValidAttributeResult) {
        ...
        expectedResult.declarations = std::vector<Declaration>();
        expectedResult.declarations.push_back(Declaration(Declaration::DesignEntity::Statement, "sss"));
        expectedResult.target = Result(Result::Types::Tuple, std::vector<std::variant<Declaration, AttrReference>>({ AttrReference(Declaration(Declaration::DesignEntity::Statement, "sss"), AttrReference::Attribute::StmtNum) }));
        expectedResult.relations = std::vector<Relation>();
        expectedResult.patterns = std::vector<Pattern>();
        expectedResult.results = std::vector<std::string>();
