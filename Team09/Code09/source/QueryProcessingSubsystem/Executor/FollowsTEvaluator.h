...
public:
	...
	std::unordered_set<std::pair<PrevLine, NextLine>> FollowsTEvaluator::leftSynonymRightSynonym() override {
		std::unordered_set<std::pair<PrevLine, NextLine>> results = pkb.getAllFollowsT();
		return results;
	}
