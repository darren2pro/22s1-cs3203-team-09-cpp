...
public:
     ...
     */
	static bool isBasicQueryString(std::string argument) {
     ...
     */
    static bool isBasicQueryStatementNumber(std::string argument) {
        for (char c : argument) {
     ...
     */
    static bool isBasicQuerySimple(std::string argument) {
